...
Sign::Sign(GameObject* parent)
    ...
    SIGN1_POS(XMFLOAT3( 2, 0, 0)), SIGN2_POS(XMFLOAT3( 8, 0, 0)),SIGN3_POS(XMFLOAT3(11, 0, 0)),
    SIGN4_POS(XMFLOAT3(14, 0, 0)), SIGN5_POS(XMFLOAT3(28, 0, 0)),SIGN6_POS(XMFLOAT3(31, 0, 0)),
    SIGN_SIZE(XMFLOAT3(1.7f,1.7f,1.7f)),
    TUTORIAL_POS(XMFLOAT3(0,   0.65f, 0)),TUTORIAL_SCA(XMFLOAT3(0.5f, 0.5f, 0.5f))
{
